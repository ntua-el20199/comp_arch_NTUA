...
def process_benchmarks(base_dir="."):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("geometric_mean_ipc_barchart.png", dpi=300)
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("geometric_mean_amat_barchart.png", dpi=300)
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("geometric_mean_l2_mpki_barchart.png", dpi=300)
